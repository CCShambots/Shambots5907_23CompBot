...
public class ClawVision extends StateMachine<ClawVision.VisionState> {
  ...
  protected void update() {
    ...
    // if(gridType == GridElement.Type.Both && getState() != CUBE_DETECTOR)
    // requestTransition(CUBE_DETECTOR);
    // if(gridType == GridElement.Type.Cone && getState() != CONE_DETECTOR)
    // requestTransition(CONE_DETECTOR);
    // if(gridType == GridElement.Type.Cube && getState() != CUBE_DETECTOR)
    // requestTransition(CUBE_DETECTOR);
  }
