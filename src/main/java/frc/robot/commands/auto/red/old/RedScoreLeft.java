package frc.robot.commands.auto.red.old;
...
public class RedScoreLeft extends SequentialCommandGroup {

    public RedScoreLeft(RobotContainer rc) {
        addCommands(
                rc.waitForReady(),
                ...
                new ParallelCommandGroup(
                    rc.runTraj("red-score-left", true),
